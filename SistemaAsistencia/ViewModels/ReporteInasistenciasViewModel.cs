...
{
    public class ReporteInasistenciasViewModel : BaseViewModel
    {
        private DateTime _fechaInicio;
        private DateTime _fechaFin;
        private List<ReporteInasistenciaItem> _registros = new();
        ...
        public List<ReporteInasistenciaItem> Registros
        {
            get => _registros;
            set
            {
        ...
        public ReporteInasistenciasViewModel()
        {
        ...
        {
            Registros = _reporteService.ObtenerInasistencias(FechaInicio, FechaFin);
        }
    }
}
